...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-chart-area"></i> Hasil Akhir Perangkingan</h1>
		...
		<div class="table-responsive">
			<table class="table table-bordered" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<td><?= number_format(floor(($keys->nilai + 0.00000000001) * 10000) / 10000, 4, '.', '') ?></td>
